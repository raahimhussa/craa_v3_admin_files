...
const withLeftButtons: WrappingFunction = (WrappedComponent: any) =>
  observer((props) => {
    ...
    const leftButtons: AdminButton[] = [
      ...
      //     modal.open(
      //       'DocumentBuilder',
      //       <DocumentBuilder_ck mutate={documentsMutate} />
      //     )
      //   },
      // },
      {
        ...
        onClick: async () => {
          ...
          modal.open(
            'DocumentBuilder',
            <DocumentBuilder mutate={documentsMutate} type="tinymce" />
          )
        },
      },
      // {
      ...
      //     modal.open(
      //       'DocumentBuilder',
      //       <DocumentBuilder mutate={documentsMutate} type="syncfusion" />
      //     )
      //   },
      // },
    ]
