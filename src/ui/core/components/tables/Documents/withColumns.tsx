  ...
  observer((props: any) => {
    ...
    const columns: Array<AdminColumn> = [
      ...
      },
      {
        ...
        Cell: CellButtons,
        storeKey: 'documentStore',
        mutateKey: 'documents',
        edit: async (_props) => {
          documentStore.resetForm()
          documentStore.pages = []
          documentStore.form = _props.row.original
          // Promise.all(
          //   _props.row.original.versions[
          //     _props.row.original.versions.length - 1
          ...
          //       documentStore.pages.push(res.data[0])
          //     })
          //   })
          // )
          modal.open('Document', <DocumentBuilder type="tinymce" />)
        },
        minWidth: 200,
        maxWidth: 200,
      },
